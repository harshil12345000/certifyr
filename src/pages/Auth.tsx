...
const Auth = () => {
  ...
  return <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gradient-to-b from-background to-muted/30">
      <div className="w-full max-w-md">
        ...
        <div className="glass-card p-6">
          <div className="flex mb-6">
            <button type="button" className={`flex-1 py-2 text-center ${isLogin ? 'border-b-2 border-primary font-medium' : 'text-muted-foreground'}`} onClick={() => setIsLogin(true)}>
              Login
            </button>
            <button type="button" className={`flex-1 py-2 text-center ${!isLogin ? 'border-b-2 border-primary font-medium' : 'text-muted-foreground'}`} onClick={() => setIsLogin(false)}>
              Sign Up
            </button>
          </div>
              ...
              field
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input className="pl-9" type={showPassword ? 'text' : 'password'} placeholder="••••••••" {...field} />
