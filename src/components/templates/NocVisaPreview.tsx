...
export const NocVisaPreview: React.FC<ExtendedNocVisaPreviewProps> = ({
  ...
  useEffect(() => {
    const fetchBranding = async () => {
      if (!institutionName && !user?.id) {
        console.warn(
          "NOC Visa Preview: Institution name or user context not available for fetching branding.",
        );
        return;
      }
      try {
  ...
  return (
    <div className="a4-document p-8 bg-white text-gray-800 text-sm leading-relaxed">
      ...
      <div className="mb-6">
        <p>
          <strong>Ref. No.:</strong> NOC/VISA/{new Date().getFullYear()}/______
        </p>
        <p>
      ...
      <div className="mb-6">
        ...
        <p>
          Embassy/Consulate of {destinationCountry || "[Destination Country]"}
        </p>
      ...
      <div className="mb-6">
        <p>
          <strong>Subject:</strong> No Objection Certificate for Visa
          Application - {fullName || "[Employee Name]"}
        </p>
      </div>
      ...
      <div className="space-y-4 text-justify leading-7">
        <p>
          ...
          <strong>{employeeId || "[Employee ID]"}</strong>, working as{" "}
          <strong>{designation || "[Designation]"}</strong> in the
          <strong> {department || "[Department]"}</strong> department of our
          organization, has been granted permission to travel to{" "}
          <strong>{destinationCountry || "[Destination Country]"}</strong>
          for the purpose of{" "}
          <strong>{travelPurpose || "[Travel Purpose]"}</strong>.
        </p>
        ...
        <p>
          The organization has no objection to the employee's travel and will
          continue employment upon return. The employee is expected to return to
          duties on or before the expected return date mentioned above.
        </p>

        <p>
          We request you to kindly consider the visa application favorably and
          grant the necessary visa to enable the employee to travel for the
          stated purpose.
        </p>
        ...
        <p className="mt-6">Thank you for your kind consideration.</p>
      </div>
