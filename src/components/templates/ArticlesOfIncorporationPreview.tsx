...
interface ExtendedArticlesOfIncorporationPreviewProps
  extends ArticlesOfIncorporationPreviewProps {
  isEmployeePreview?: boolean;
  requestStatus?: "pending" | "approved" | "rejected";
}

export const ArticlesOfIncorporationPreview: React.FC<
  ExtendedArticlesOfIncorporationPreviewProps
  ...
  useEffect(() => {
    ...
    const generateQR = async () => {
      if (companyName && stateOfIncorporation && registeredAgent) {
        ...
        if (!url) {
          console.error(
            "QR code URL generation failed for Articles of Incorporation Preview.",
          );
        }
      }
    };
  ...
  return (
    <div className="a4-document p-8 bg-white text-gray-800 font-sans text-sm leading-relaxed relative">
      ...
      <div className="mb-6">
        ...
        <p>
          The name of this corporation is <strong>{companyName}</strong>.
        </p>
      </div>
      ...
      <div className="mb-6">
        ...
        <p>
          ...
          Corporation Law of {stateOfIncorporation}.
        </p>
      ...
      <div className="mb-6">
        ...
        <p>
          ...
          <strong>{authorizedShares}</strong> shares of common stock
          {shareClasses && `, with a par value of ${shareClasses} per share`}.
        </p>
      </div>
      ...
      <div className="mb-8">
        ...
        <p className="ml-4">
          <strong>{incorporators[0].name}</strong>
        </p>
      ...
      <div className="mt-12">
        <p className="mb-6">
          ...
          {issueDate ? new Date(issueDate).toLocaleDateString() : "[Date]"} day.
        </p>
        ...
        <div className="flex justify-between items-end">
          <div>
            ...
            <p className="text-sm">
              <strong>Place:</strong> {incorporators[0].place || "[Place]"}
            </p>
          </div>
