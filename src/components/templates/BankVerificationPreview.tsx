...
interface ExtendedBankVerificationPreviewProps
  extends BankVerificationPreviewProps {
  isEmployeePreview?: boolean;
  requestStatus?: "pending" | "approved" | "rejected";
}

export const BankVerificationPreview: React.FC<
  ExtendedBankVerificationPreviewProps
  ...
  useEffect(() => {
    const generateQR = async () => {
      if (fullName && bankName && accountNumber) {
        ...
        if (!url) {
          console.error(
            "QR code URL generation failed for Bank Verification Preview.",
          );
        }
      }
    };
  ...
  return (
    <div className="a4-document p-8 bg-white text-gray-800 text-sm leading-relaxed relative">
      ...
      <div className="flex justify-between mb-6 text-sm">
        <p>
          <strong>Reference No.:</strong> BAV/{new Date().getFullYear()}/______
        </p>
        <p>
      ...
      <div className="space-y-6 text-base leading-7">
        ...
        <p className="text-justify">
          ...
          <strong>{fullName || "[Employee Name]"}</strong> (Employee ID:{" "}
          <strong>{employeeId || "[Employee ID]"}</strong>) is a regular
          employee of our organization working as{" "}
        ...
        <p className="text-justify">
          ...
          <strong>
            ₹ {formatCurrency(currentSalary) || "[Current Salary]"}
          </strong>{" "}
          per month, which is directly credited to the following bank account:
        </p>
        ...
        <div className="ml-8 space-y-2">
          ...
          <p>
            <strong>Bank Name:</strong> {bankName || "[Bank Name]"}
          </p>
          <p>
          ...
          <p>
            ...
            {getAccountTypeText(accountType || "savings")}
          </p>
          <p>
            <strong>IFSC Code:</strong> {ifscCode || "[IFSC Code]"}
          </p>
          <p>
            <strong>Branch Name:</strong> {branchName || "[Branch Name]"}
          </p>
          <p>
        ...
        <p className="text-justify">
          We hereby confirm that the above-mentioned bank account details are
          authentic and belong to our employee. The salary of the employee is
          directly credited to this account on a monthly basis.
        </p>

        <p className="text-justify">
          This letter is being issued for{" "}
          <strong>
        ...
        <p className="text-justify text-sm">
          <strong>Disclaimer:</strong> This letter is issued based on the
          records available with us and is valid as on the date of issue. The
          organization does not take any responsibility for any financial
          transactions or commitments made by the employee.
        </p>

        <p className="text-center font-medium">
          This letter is issued upon the request of the employee for official
          purposes only.
        </p>
      </div>
