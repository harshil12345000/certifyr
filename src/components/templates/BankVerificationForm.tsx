...
export const BankVerificationForm: React.FC<BankVerificationFormProps> = ({ onSubmit, initialData }) => {
    ...
    <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          {form.formState.errors.joinDate && (
            <p className="text-red-500 text-sm mt-1">{form.formState.errors.joinDate.message}</p>
          )}
        </div>
        ...
        <div>
          ...
          {form.formState.errors.currentSalary && (
            <p className="text-red-500 text-sm mt-1">{form.formState.errors.currentSalary.message}</p>
          )}
        </div>
        ...
        <div>
          ...
          <Select
            ...
            onValueChange={(value) => form.setValue('accountType', value as 'savings' | 'current' | 'salary')}
          >
            <SelectTrigger>
      ...
      <div>
        ...
        {form.formState.errors.branchAddress && (
          <p className="text-red-500 text-sm mt-1">{form.formState.errors.branchAddress.message}</p>
        )}
      </div>
