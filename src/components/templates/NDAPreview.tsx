...
export const NDAPreview: React.FC<ExtendedNDAPreviewProps> = ({
  data,
    ...
    <div className="a4-document p-8 bg-white text-gray-800 font-sans text-sm leading-relaxed">
      ...
      <div className="space-y-6 text-justify leading-7 text-base">
        <p>
          ...
          between <strong>{disclosingParty || "[Disclosing Party]"}</strong>,
          having its principal place of business at{" "}
          <strong>
            {disclosingPartyAddress || "[Disclosing Party Address]"}
          </strong>
          ("Disclosing Party") and{" "}
          <strong>{receivingParty || "[Receiving Party]"}</strong>, having its
        ...
        <div className="mb-6">
          ...
          <p>
            The purpose of this Agreement is to permit the parties to evaluate{" "}
            {purposeOfDisclosure || "[Purpose of Disclosure]"}.
          </p>
        </div>
        ...
        <div className="mb-6">
          ...
          <p>
            ...
            that: {exclusions || "[Exclusions from confidentiality]"}
          </p>
        </div>
        ...
        <div className="mb-6">
          ...
          <p>
            ...
            {termLength || "[Term Length]"} from the date of execution.
          </p>
        </div>
        ...
        <div className="mb-6">
          ...
          <p>
            {returnOfInformation ||
              "[Return of confidential information provisions]"}
          </p>
        </div>
