  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2 md:col-span-2">
          <Label htmlFor="confidentialInformation">Definition of Confidential Information *</Label>
          <Textarea
            id="confidentialInformation"
            value={formData.confidentialInformation}
            onChange={(e) => handleChange('confidentialInformation', e.target.value)}
        ...
        <div className="space-y-2 md:col-span-2">
          ...
          <Textarea
            ...
            onChange={(e) => handleChange('returnOfInformation', e.target.value)}
